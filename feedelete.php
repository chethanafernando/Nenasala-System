...
<body>
	<div id='modal-wrapper' class='modal'>
			<span onclick="document.getElementById('modal-wrapper').style.dispaly='none'" class='close' title='Close PopUp'>&times;</span>
				...
				?>
				<center>
				<h1><a href='fee.php' style="font-size:35px;color:yellow;"><i class="fa fa-arrow-circle-left"></i></a>&nbsp;&nbsp;&nbsp;Delete Record</h1>
				<form class='modal-content animate' action='feedelete2.php'><br>
						<table border='0' >
							<tr>
						...
						<table border='0'>
							<tr>
								<td><a href='feedelete2.php?i=<?php echo $id; ?>'>Delete</a></td>
							</tr>
						</table>
					</center>
				</div>
