		...
		while($row = $result->fetch_assoc())
			{
				...
				echo " 
					...
					";
				?>
							<td colspan='10' align='center'><a href='exregdelete.php?i=<?php echo $row['Exam_Id']; ?>'  class='btn btn-warning' >Delete</a></td>
				<?php
				echo"
							</tr>
					</tbody>
