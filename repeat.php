...
<html>
	<head>
		<title>Repeat Exam Application</title>
		<meta charset='UTF-8'>
	...
	<center>
		<div class="container-fluid">
            <div class="block-header">
				...
				<button style="background-color: Transparent;border:0px;overflow: hidden;"><i class="fa fa-home" style="font-size:60px; color:black;margin-top:5px;margin-left:5px;"></i></button>&nbsp;&nbsp;Repeat Exam Form 
				&nbsp;&nbsp;
				</form>
				</h2>
            </div>
				<div class="row clearfix">
					<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
						<div class="card">
                            ...
                            <br>
                                <form action="repeatcode.php">
									<table border="0" align="center" height="auto" width="90%" cellpadding="10" cellspacing="10">
										<tr>
											<td><input type="text" id="reid" placeholder="Enter Repaet Exam ID" name="reid" class="form-control" required></td>
										</tr>
										<tr>
											<td><input type="text" id="exid" placeholder="Enter Exam ID" name="exid" class="form-control" required></td>
										</tr>
										<tr>
										...
										<tr>
											<td><input type="text" id="oresult" placeholder="Enter Older Result or Grade" name="oresult" class="form-control"></td>
										</tr>
										<tr>
											<td><input type="number" id="attemp" placeholder="Enter Attempt" name="attemp" class="form-control" required></td>
										</tr>
										<tr>
										...
										<tr>
											<td>
												...
												<a href="repeatdatabase.php" class="btn btn-primary">View Database</a>
											</td>
										</tr>
									</table>
                                </form>
